...
const std::unordered_map<std::string, TokenType> Scanner::keywords = {
    ...
    {"let", TokenType::LET},       {"const", TokenType::CONST}, {"or", TokenType::OR},
    {"return", TokenType::RETURN}, {"true", TokenType::TRUE},   {"while", TokenType::WHILE},
    {"null", TokenType::NIL},      {"i32", TokenType::I32},     {"i64", TokenType::I64},
    {"u32", TokenType::U32},       {"u64", TokenType::U64},     {"f32", TokenType::F32},
    {"f64", TokenType::F64},       {"bool", TokenType::BOOL},   {"string", TokenType::STRING_TYPE},
};
...
bool Scanner::isAtEnd() const { return current_ >= static_cast<int>(source_.length()); }
